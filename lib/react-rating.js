...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _PercentageSymbol = __webpack_require__(5);
	...
	var Rating = (function (_React$Component) {
	  ...
	  _createClass(Rating, [{
	    ...
	    value: function render() {
	      ...
	      var other = _objectWithoutProperties(_props, ['start', 'stop', 'step', 'initialRate', 'placeholderRate', 'readonly', 'quiet', 'fractions', 'scale', 'onChange', 'onClick', 'onRate']);
	      ...
	      var icon = !this.state.selected && initialRate === undefined && placeholderRate !== undefined && (quiet || this.state.indexOver === undefined) ? placeholder : full;
