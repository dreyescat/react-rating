/*! react-rating - 1.3.1 | (c) 2015, 2018  dreyescat | MIT | https://github.com/dreyescat/react-rating */
...
function (_React$PureComponent) {
  ...
  _createClass(RatingAPILayer, [{
    ...
    value: function handleClick(value, e) {
      ...
      var newValue = this.translateDisplayValueToValue(value); // Avoid calling setState if not necessary. Micro optimisation.
