...
*/
'use strict';function D(r){function T(a){return a[1].toUpperCase()}function u(a){if("boolean"===typeof a||"number"===typeof a)return""+a;a=""+a;var b=U.exec(a);if(b){var e="",c,n=0;for(c=b.index;c<a.length;c++){switch(a.charCodeAt(c)){case 34:b="\x26quot;";break;case 38:b="\x26amp;";break;case 39:b="\x26#x27;";break;case 60:b="\x26lt;";break;case 62:b="\x26gt;";break;default:continue}n!==c&&(e+=a.substring(n,c));n=c+1;e+=b}a=n!==c?e+a.substring(n,c):e}return a}function p(a){for(var b=arguments.length-
...
default:return!1}},getPropertyInfo:function(a){return m.properties.hasOwnProperty(a)?m.properties[a]:null},shouldAttributeAcceptBooleanValue:function(a){if(m.isReservedProp(a))return!0;var b=m.getPropertyInfo(a);if(b)return b.hasBooleanValue||b.hasStringBooleanValue||b.hasOverloadedBooleanValue;a=a.toLowerCase().slice(0,5);return"data-"===a||"aria-"===a},isReservedProp:function(a){return Z.hasOwnProperty(a)},injection:O},k=m,U=/["'&<>]/,V=new RegExp("^["+k.ATTRIBUTE_NAME_START_CHAR+"]["+k.ATTRIBUTE_NAME_CHAR+
"]*$"),L={},K={},F={createMarkupForID:function(a){return k.ID_ATTRIBUTE_NAME+"\x3d"+('"'+u(a)+'"')},createMarkupForRoot:function(){return k.ROOT_ATTRIBUTE_NAME+'\x3d""'},createMarkupForProperty:function(a,b){var e=k.getPropertyInfo(a);if(e){if(null==b||e.hasBooleanValue&&!b||e.hasNumericValue&&isNaN(b)||e.hasPositiveNumericValue&&1>b||e.hasOverloadedBooleanValue&&!1===b)return"";var c=e.attributeName;if(e.hasBooleanValue||e.hasOverloadedBooleanValue&&!0===b)return c+'\x3d""';if("boolean"!==typeof b||
k.shouldAttributeAcceptBooleanValue(a))return c+"\x3d"+('"'+u(b)+'"')}else if(k.shouldSetAttribute(a,b)&&J(a))return null==b?"":a+"\x3d"+('"'+u(b)+'"');return null},createMarkupForCustomAttribute:function(a,b){return J(a)&&null!=b?a+"\x3d"+('"'+u(b)+'"'):""}},P={area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0},aa=x({menuitem:!0},P),A={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,
...
ba=["Webkit","ms","Moz","O"];Object.keys(A).forEach(function(a){ba.forEach(function(b){b=b+a.charAt(0).toUpperCase()+a.substring(1);A[b]=A[a]})});var M={},ca=/([A-Z])/g,da=/^ms-/,G=r.Children.toArray,ea={listing:!0,pre:!0,textarea:!0},fa=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,Q={},ha=function(a){var b={};return function(e){b.hasOwnProperty(e)||(b[e]=a.call(this,e));return b[e]}}(function(a){return a.replace(ca,"-$1").toLowerCase().replace(da,"-ms-")}),ia={children:null,dangerouslySetInnerHTML:null,suppressContentEditableWarning:null},
R=function(){function a(b,e){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.stack=[{domNamespace:"http://www.w3.org/1999/xhtml",children:r.isValidElement(b)?[b]:G(b),childIndex:0,context:M,footer:""}];this.exhausted=!1;this.currentSelectValue=null;this.previousWasTextNode=!1;this.makeStaticMarkup=e}a.prototype.read=function(a){if(this.exhausted)return null;for(var b="";b.length<a;){if(0===this.stack.length){this.exhausted=!0;break}var c=this.stack[this.stack.length-
...
a.replace(ja,T);H.Properties[b]=0;H.DOMAttributeNames[b]=a});k.injection.injectDOMPropertyConfig(z);k.injection.injectDOMPropertyConfig(H);return{renderToString:function(a){return(new R(a,!1)).read(Infinity)},renderToStaticMarkup:function(a){return(new R(a,!0)).read(Infinity)},renderToNodeStream:function(){p("207")},renderToStaticNodeStream:function(){p("208")},version:"16.0.1"}}
